...
pub struct ThemeBackdrop {
    pub visible: bool,
    pub variant: crate::resources::ThemeVariant,
}

impl ThemeBackdrop {
    pub const fn visible(variant: crate::resources::ThemeVariant) -> Self {
        Self { visible: true, variant }
    }
}

impl Default for ThemeBackdrop {
    fn default() -> Self {
        Self::visible(crate::resources::ThemeVariant::Aurora)
    }
}

impl fhre::Component for ThemeBackdrop {
    fn type_name() -> &'static str { "ThemeBackdrop" }
}
...
impl LauncherIcon {
    pub const fn hidden(app_id: u32, index: u8) -> Self {
        Self {
            app_id,
            visible: false,
            index,
...
impl fhre::Component for LauncherIcon {
    fn type_name() -> &'static str { "LauncherIcon" }
}

#[derive(Clone, Copy, Debug, PartialEq, Eq)]
pub struct LauncherIconLabel {
    pub app_id: u32,
    pub index: u8,
}

impl LauncherIconLabel {
    pub const fn for_icon(app_id: u32, index: u8) -> Self {
        Self { app_id, index }
    }
}

impl fhre::Component for LauncherIconLabel {
    fn type_name() -> &'static str { "LauncherIconLabel" }
}
...
// === System built-in page navigation ===

#[derive(Clone, Copy, Debug, PartialEq, Eq)]
pub enum SystemNavAction {
    BackHome,
}

impl SystemNavAction {
...
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
pub struct SystemNavButton {
    pub surface_id: SurfaceId,
    pub action: SystemNavAction,
    pub visible: bool,
}

impl SystemNavButton {
    pub const fn hidden(surface_id: SurfaceId, action: SystemNavAction) -> Self {
        Self { surface_id, action, visible: false }
    }
}

impl fhre::Component for SystemNavButton {
    fn type_name() -> &'static str { "SystemNavButton" }
}

#[derive(Clone, Copy, Debug, PartialEq, Eq)]
pub struct SystemNavButtonLabel {
    pub surface_id: SurfaceId,
    pub action: SystemNavAction,
}

impl SystemNavButtonLabel {
    pub const fn for_button(surface_id: SurfaceId, action: SystemNavAction) -> Self {
        Self { surface_id, action }
    }
}

impl fhre::Component for SystemNavButtonLabel {
    fn type_name() -> &'static str { "SystemNavButtonLabel" }
}
...
impl SettingsAction {
    pub const fn label(self) -> &'static str {
        match self {
            Self::ToggleWifi => "Wi-Fi",
            Self::ToggleBluetooth => "Bluetooth",
            Self::ToggleAirplaneMode => "Airplane Mode",
            Self::ToggleFlashlight => "Flashlight",
            Self::ToggleDnd => "Do Not Disturb",
            Self::ToggleAutoRotate => "Auto Rotate",
            Self::CycleBrightness => "Brightness",
            Self::CycleTheme => "Theme",
            Self::CyclePreviewEffect => "Preview Effect",
        }
    }

    pub fn is_active(self, content: &crate::resources::ShellContent) -> bool {
        match self {
            Self::ToggleWifi => content.quick_controls.wifi_enabled,
            Self::ToggleBluetooth => content.quick_controls.bluetooth_enabled,
            Self::ToggleAirplaneMode => content.quick_controls.airplane_mode,
            Self::ToggleFlashlight => content.quick_controls.flashlight_on,
            Self::ToggleDnd => content.quick_controls.dnd_mode,
            Self::ToggleAutoRotate => content.quick_controls.auto_rotate,
            Self::CycleBrightness => content.quick_controls.brightness >= 0.5,
            Self::CycleTheme => false,
            Self::CyclePreviewEffect => {
                content.preview_effect == crate::resources::PreviewEffect::Soccer
            }
        }
    }
}
...
impl SettingsPanel {
    pub const fn hidden(surface_id: SurfaceId) -> Self {
        Self { surface_id, visible: false }
    }
}

impl fhre::Component for SettingsPanel {
    fn type_name() -> &'static str { "SettingsPanel" }
}
...
impl SettingsRow {
    pub const fn hidden(surface_id: SurfaceId, index: u8, action: SettingsAction) -> Self {
        Self {
            surface_id,
            index,
            action,
...
impl fhre::Component for SettingsRow {
    fn type_name() -> &'static str { "SettingsRow" }
}
...
impl SettingsRowLabel {
    pub const fn for_row(surface_id: SurfaceId, index: u8, action: SettingsAction) -> Self {
        Self { surface_id, index, action }
    }
}

impl fhre::Component for SettingsRowLabel {
    fn type_name() -> &'static str { "SettingsRowLabel" }
}

#[derive(Clone, Copy, Debug, PartialEq, Eq)]
pub struct SettingsRowValue {
    pub surface_id: SurfaceId,
    pub index: u8,
    pub action: SettingsAction,
}

impl SettingsRowValue {
    pub const fn for_row(surface_id: SurfaceId, index: u8, action: SettingsAction) -> Self {
        Self { surface_id, index, action }
    }
}

impl fhre::Component for SettingsRowValue {
    fn type_name() -> &'static str { "SettingsRowValue" }
}
