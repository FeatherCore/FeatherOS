...
const HOME_SURFACE_ID: crate::types::SurfaceId = 1;
            ...
            ShellOverlayMode::None => {
                ...
                match direction {
                    crate::resources::SwipeDirection::Down => {
                        shell_state.open_overlay(ShellOverlayMode::NotificationPanel);
                    }
                    crate::resources::SwipeDirection::Up => {
                        shell_state.open_overlay(ShellOverlayMode::AppSwitcher);
                    }
                    _ => {}
                }
            }
