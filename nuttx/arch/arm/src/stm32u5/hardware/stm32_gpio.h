...
#  define STM32_GPIOJ_SECCFGR      (STM32_GPIOJ_BASE + STM32_GPIO_SECCFGR_OFFSET)
#  define STM32_GPIOJ_HSLVR        (STM32_GPIOJ_BASE + STM32_GPIO_HSLVR_OFFSET)
#endif
...
/* GPIO high-speed low-voltage register (HSLVR) */
