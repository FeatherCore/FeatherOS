...
#define GPIO_ADC1_IN17_1        (GPIO_ANALOG|GPIO_PORTB|GPIO_PIN2)

/* ADC2 - Analog-to-digital converter */

#define GPIO_ADC2_IN1_1         (GPIO_ANALOG|GPIO_PORTC|GPIO_PIN0)
#define GPIO_ADC2_IN2_1         (GPIO_ANALOG|GPIO_PORTC|GPIO_PIN1)
#define GPIO_ADC2_IN3_1         (GPIO_ANALOG|GPIO_PORTC|GPIO_PIN2)
#define GPIO_ADC2_IN4_1         (GPIO_ANALOG|GPIO_PORTC|GPIO_PIN3)
#define GPIO_ADC2_IN5_1         (GPIO_ANALOG|GPIO_PORTA|GPIO_PIN0)
#define GPIO_ADC2_IN6_1         (GPIO_ANALOG|GPIO_PORTA|GPIO_PIN1)
#define GPIO_ADC2_IN7_1         (GPIO_ANALOG|GPIO_PORTA|GPIO_PIN2)
#define GPIO_ADC2_IN8_1         (GPIO_ANALOG|GPIO_PORTA|GPIO_PIN3)
#define GPIO_ADC2_IN9_1         (GPIO_ANALOG|GPIO_PORTA|GPIO_PIN4)
#define GPIO_ADC2_IN10_1        (GPIO_ANALOG|GPIO_PORTA|GPIO_PIN5)
#define GPIO_ADC2_IN11_1        (GPIO_ANALOG|GPIO_PORTA|GPIO_PIN6)
#define GPIO_ADC2_IN12_1        (GPIO_ANALOG|GPIO_PORTA|GPIO_PIN7)
#define GPIO_ADC2_IN13_1        (GPIO_ANALOG|GPIO_PORTC|GPIO_PIN4)
#define GPIO_ADC2_IN14_1        (GPIO_ANALOG|GPIO_PORTC|GPIO_PIN5)
#define GPIO_ADC2_IN15_1        (GPIO_ANALOG|GPIO_PORTB|GPIO_PIN0)
#define GPIO_ADC2_IN16_1        (GPIO_ANALOG|GPIO_PORTB|GPIO_PIN1)
#define GPIO_ADC2_IN17_1        (GPIO_ANALOG|GPIO_PORTB|GPIO_PIN2)
...
#define GPIO_ADF1_CCK0_3        (GPIO_ALT|GPIO_AF3|GPIO_PORTF|GPIO_PIN3)
...
#define GPIO_ADF1_SDI0_4        (GPIO_ALT|GPIO_AF3|GPIO_PORTF|GPIO_PIN4)
...
#define GPIO_OCTOSPIM_P1_IO5_2  (GPIO_ALT|GPIO_AF10|GPIO_PORTC|GPIO_PIN2)
#define GPIO_OCTOSPIM_P1_IO5_3  (GPIO_ALT|GPIO_AF10|GPIO_PORTD|GPIO_PIN5)
...
#define GPIO_OCTOSPIM_P1_NCS_3  (GPIO_ALT|GPIO_AF10|GPIO_PORTA|GPIO_PIN2)
#define GPIO_OCTOSPIM_P1_NCS_4  (GPIO_ALT|GPIO_AF10|GPIO_PORTB|GPIO_PIN11)
#define GPIO_OCTOSPIM_P1_NCS_5  (GPIO_ALT|GPIO_AF10|GPIO_PORTE|GPIO_PIN11)
...
#define GPIO_OCTOSPIM_P2_NCS_1  (GPIO_ALT|GPIO_AF10|GPIO_PORTA|GPIO_PIN0)
#define GPIO_OCTOSPIM_P2_NCS_2  (GPIO_ALT|GPIO_AF6|GPIO_PORTA|GPIO_PIN12)
#define GPIO_OCTOSPIM_P2_NCS_3  (GPIO_ALT|GPIO_AF5|GPIO_PORTF|GPIO_PIN6)
#define GPIO_OCTOSPIM_P2_NCS_4  (GPIO_ALT|GPIO_AF5|GPIO_PORTG|GPIO_PIN12)
#define GPIO_OCTOSPIM_P2_NCS_5  (GPIO_ALT|GPIO_AF5|GPIO_PORTI|GPIO_PIN5)
#define GPIO_OCTOSPIM_P2_NCS_6  (GPIO_ALT|GPIO_AF10|GPIO_PORTD|GPIO_PIN3)

/* HSPI1 - Hexadeca Serial peripheral interface */
#define GPIO_HSPI1_NCS_1        (GPIO_ALT|GPIO_AF8|GPIO_PORTH|GPIO_PIN9)
#define GPIO_HSPI1_DQS0_1       (GPIO_ALT|GPIO_AF8|GPIO_PORTI|GPIO_PIN2)
#define GPIO_HSPI1_DQS1_1       (GPIO_ALT|GPIO_AF8|GPIO_PORTI|GPIO_PIN8)
#define GPIO_HSPI1_CLK_1        (GPIO_ALT|GPIO_AF8|GPIO_PORTI|GPIO_PIN3)
#define GPIO_HSPI1_NCLK_1       (GPIO_ALT|GPIO_AF8|GPIO_PORTI|GPIO_PIN4)
#define GPIO_HSPI1_IO0_1        (GPIO_ALT|GPIO_AF8|GPIO_PORTH|GPIO_PIN10)
#define GPIO_HSPI1_IO1_1        (GPIO_ALT|GPIO_AF8|GPIO_PORTH|GPIO_PIN11)
#define GPIO_HSPI1_IO2_1        (GPIO_ALT|GPIO_AF8|GPIO_PORTH|GPIO_PIN12)
#define GPIO_HSPI1_IO3_1        (GPIO_ALT|GPIO_AF8|GPIO_PORTH|GPIO_PIN13)
#define GPIO_HSPI1_IO4_1        (GPIO_ALT|GPIO_AF8|GPIO_PORTH|GPIO_PIN14)
#define GPIO_HSPI1_IO5_1        (GPIO_ALT|GPIO_AF8|GPIO_PORTH|GPIO_PIN15)
#define GPIO_HSPI1_IO6_1        (GPIO_ALT|GPIO_AF8|GPIO_PORTI|GPIO_PIN0)
#define GPIO_HSPI1_IO7_1        (GPIO_ALT|GPIO_AF8|GPIO_PORTI|GPIO_PIN1)
#define GPIO_HSPI1_IO8_1        (GPIO_ALT|GPIO_AF8|GPIO_PORTI|GPIO_PIN9)
#define GPIO_HSPI1_IO9_1        (GPIO_ALT|GPIO_AF8|GPIO_PORTI|GPIO_PIN10)
#define GPIO_HSPI1_IO10_1       (GPIO_ALT|GPIO_AF8|GPIO_PORTI|GPIO_PIN11)
#define GPIO_HSPI1_IO11_1       (GPIO_ALT|GPIO_AF8|GPIO_PORTI|GPIO_PIN12)
#define GPIO_HSPI1_IO12_1       (GPIO_ALT|GPIO_AF8|GPIO_PORTI|GPIO_PIN13)
#define GPIO_HSPI1_IO13_1       (GPIO_ALT|GPIO_AF8|GPIO_PORTI|GPIO_PIN14)
#define GPIO_HSPI1_IO14_1       (GPIO_ALT|GPIO_AF8|GPIO_PORTI|GPIO_PIN15)
#define GPIO_HSPI1_IO15_1       (GPIO_ALT|GPIO_AF8|GPIO_PORTJ|GPIO_PIN0)
...
#define GPIO_SDMMC2_D1_1        (GPIO_ALT|GPIO_AF8|GPIO_PORTA|GPIO_PIN8)
#define GPIO_SDMMC2_D1_2        (GPIO_ALT|GPIO_AF12|GPIO_PORTB|GPIO_PIN15)
...
#define GPIO_USART6_CK_1         (GPIO_ALT|GPIO_AF7|GPIO_PORTC|GPIO_PIN1)
#define GPIO_USART6_CK_2         (GPIO_ALT|GPIO_AF7|GPIO_PORTJ|GPIO_PIN6)
#define GPIO_USART6_CTS_1        (GPIO_ALT|GPIO_AF7|GPIO_PORTD|GPIO_PIN13)
#define GPIO_USART6_CTS_2        (GPIO_ALT|GPIO_AF7|GPIO_PORTJ|GPIO_PIN7)
#define GPIO_USART6_RTS_DE_1    (GPIO_ALT|GPIO_AF7|GPIO_PORTD|GPIO_PIN14)
#define GPIO_USART6_RTS_DE_2    (GPIO_ALT|GPIO_AF7|GPIO_PORTJ|GPIO_PIN5)
#define GPIO_USART6_RX_1         (GPIO_ALT|GPIO_AF7|GPIO_PORTD|GPIO_PIN15)
#define GPIO_USART6_RX_2         (GPIO_ALT|GPIO_AF7|GPIO_PORTE|GPIO_PIN0)
#define GPIO_USART6_RX_3         (GPIO_ALT|GPIO_AF7|GPIO_PORTJ|GPIO_PIN4)
#define GPIO_USART6_TX_1         (GPIO_ALT|GPIO_AF7|GPIO_PORTC|GPIO_PIN0)
#define GPIO_USART6_TX_2         (GPIO_ALT|GPIO_AF7|GPIO_PORTE|GPIO_PIN1)
#define GPIO_USART6_TX_3         (GPIO_ALT|GPIO_AF7|GPIO_PORTJ|GPIO_PIN3)

/* I2C5 - Inter-integrated circuit interface */

#define GPIO_I2C5_SCL_1         (GPIO_ALT|GPIO_AF4|GPIO_PORTD|GPIO_PIN1)
#define GPIO_I2C5_SCL_2         (GPIO_ALT|GPIO_AF4|GPIO_PORTH|GPIO_PIN5)
#define GPIO_I2C5_SCL_3         (GPIO_ALT|GPIO_AF4|GPIO_PORTJ|GPIO_PIN2)
#define GPIO_I2C5_SDA_1         (GPIO_ALT|GPIO_AF4|GPIO_PORTD|GPIO_PIN0)
#define GPIO_I2C5_SDA_2         (GPIO_ALT|GPIO_AF4|GPIO_PORTH|GPIO_PIN4)
#define GPIO_I2C5_SDA_3         (GPIO_ALT|GPIO_AF4|GPIO_PORTJ|GPIO_PIN1)
#define GPIO_I2C5_SMBA_1        (GPIO_ALT|GPIO_AF4|GPIO_PORTD|GPIO_PIN10)
#define GPIO_I2C5_SMBA_2        (GPIO_ALT|GPIO_AF4|GPIO_PORTH|GPIO_PIN6)
#define GPIO_I2C5_SMBA_3        (GPIO_ALT|GPIO_AF4|GPIO_PORTJ|GPIO_PIN0)

/* I2C6 - Inter-integrated circuit interface */

#define GPIO_I2C6_SCL_1         (GPIO_ALT|GPIO_AF2|GPIO_PORTD|GPIO_PIN1)
#define GPIO_I2C6_SCL_2         (GPIO_ALT|GPIO_AF2|GPIO_PORTF|GPIO_PIN1)
#define GPIO_I2C6_SCL_3         (GPIO_ALT|GPIO_AF2|GPIO_PORTJ|GPIO_PIN10)
#define GPIO_I2C6_SDA_1         (GPIO_ALT|GPIO_AF2|GPIO_PORTD|GPIO_PIN0)
#define GPIO_I2C6_SDA_2         (GPIO_ALT|GPIO_AF2|GPIO_PORTF|GPIO_PIN0)
#define GPIO_I2C6_SDA_3         (GPIO_ALT|GPIO_AF2|GPIO_PORTJ|GPIO_PIN9)
#define GPIO_I2C6_SMBA_1        (GPIO_ALT|GPIO_AF2|GPIO_PORTD|GPIO_PIN3)
#define GPIO_I2C6_SMBA_2        (GPIO_ALT|GPIO_AF2|GPIO_PORTJ|GPIO_PIN8)
...
#define GPIO_TIM3_ETR_1         (GPIO_ALT|GPIO_AF2|GPIO_PORTE|GPIO_PIN2)
#define GPIO_TIM3_CH1N_1        (GPIO_ALT|GPIO_AF2|GPIO_PORTE|GPIO_PIN3)
#define GPIO_TIM3_CH2N_1        (GPIO_ALT|GPIO_AF2|GPIO_PORTE|GPIO_PIN4)
#define GPIO_TIM3_CH3N_1        (GPIO_ALT|GPIO_AF2|GPIO_PORTE|GPIO_PIN5)
#define GPIO_TIM3_CH4N_1        (GPIO_ALT|GPIO_AF2|GPIO_PORTE|GPIO_PIN6)
#define GPIO_TIM3_BKIN_1        (GPIO_ALT|GPIO_AF2|GPIO_PORTE|GPIO_PIN7)
...
#define GPIO_LCD_B0_1           (GPIO_ALT|GPIO_AF8|GPIO_PORTB|GPIO_PIN9)
#define GPIO_LCD_B1_1           (GPIO_ALT|GPIO_AF8|GPIO_PORTB|GPIO_PIN8)
#define GPIO_LCD_B2_1           (GPIO_ALT|GPIO_AF8|GPIO_PORTD|GPIO_PIN14)
#define GPIO_LCD_B3_1           (GPIO_ALT|GPIO_AF8|GPIO_PORTD|GPIO_PIN15)
#define GPIO_LCD_B4_1           (GPIO_ALT|GPIO_AF8|GPIO_PORTD|GPIO_PIN0)
#define GPIO_LCD_B5_1           (GPIO_ALT|GPIO_AF8|GPIO_PORTD|GPIO_PIN1)
#define GPIO_LCD_B6_1           (GPIO_ALT|GPIO_AF8|GPIO_PORTE|GPIO_PIN7)
#define GPIO_LCD_B7_1           (GPIO_ALT|GPIO_AF8|GPIO_PORTE|GPIO_PIN8)
#define GPIO_LCD_CLK_1          (GPIO_ALT|GPIO_AF8|GPIO_PORTD|GPIO_PIN3)
#define GPIO_LCD_DE_1           (GPIO_ALT|GPIO_AF8|GPIO_PORTD|GPIO_PIN6)
#define GPIO_LCD_DE_2           (GPIO_ALT|GPIO_AF8|GPIO_PORTF|GPIO_PIN11)
#define GPIO_LCD_G0_1           (GPIO_ALT|GPIO_AF8|GPIO_PORTC|GPIO_PIN8)
#define GPIO_LCD_G1_1           (GPIO_ALT|GPIO_AF8|GPIO_PORTC|GPIO_PIN9)
#define GPIO_LCD_G2_1           (GPIO_ALT|GPIO_AF8|GPIO_PORTE|GPIO_PIN9)
#define GPIO_LCD_G3_1           (GPIO_ALT|GPIO_AF8|GPIO_PORTE|GPIO_PIN10)
#define GPIO_LCD_G4_1           (GPIO_ALT|GPIO_AF8|GPIO_PORTE|GPIO_PIN11)
#define GPIO_LCD_G5_1           (GPIO_ALT|GPIO_AF8|GPIO_PORTE|GPIO_PIN12)
#define GPIO_LCD_G6_1           (GPIO_ALT|GPIO_AF8|GPIO_PORTE|GPIO_PIN13)
#define GPIO_LCD_G7_1           (GPIO_ALT|GPIO_AF8|GPIO_PORTE|GPIO_PIN14)
#define GPIO_LCD_HSYNC_1       (GPIO_ALT|GPIO_AF8|GPIO_PORTE|GPIO_PIN0)
#define GPIO_LCD_R0_1           (GPIO_ALT|GPIO_AF8|GPIO_PORTC|GPIO_PIN6)
#define GPIO_LCD_R0_2           (GPIO_ALT|GPIO_AF8|GPIO_PORTG|GPIO_PIN13)
#define GPIO_LCD_R1_1           (GPIO_ALT|GPIO_AF8|GPIO_PORTC|GPIO_PIN7)
#define GPIO_LCD_R1_2           (GPIO_ALT|GPIO_AF8|GPIO_PORTG|GPIO_PIN14)
#define GPIO_LCD_R2_1           (GPIO_ALT|GPIO_AF8|GPIO_PORTE|GPIO_PIN15)
#define GPIO_LCD_R3_1           (GPIO_ALT|GPIO_AF8|GPIO_PORTD|GPIO_PIN8)
#define GPIO_LCD_R4_1           (GPIO_ALT|GPIO_AF8|GPIO_PORTD|GPIO_PIN9)
#define GPIO_LCD_R5_1           (GPIO_ALT|GPIO_AF8|GPIO_PORTD|GPIO_PIN10)
#define GPIO_LCD_R6_1           (GPIO_ALT|GPIO_AF8|GPIO_PORTD|GPIO_PIN11)
#define GPIO_LCD_R7_1           (GPIO_ALT|GPIO_AF8|GPIO_PORTD|GPIO_PIN12)
#define GPIO_LCD_VSYNC_1       (GPIO_ALT|GPIO_AF8|GPIO_PORTE|GPIO_PIN1)

/* GFXTIM - Graphics interface timer */

#define GPIO_GFXTIM_FCKCAL_1    (GPIO_ALT|GPIO_AF3|GPIO_PORTC|GPIO_PIN0)
#define GPIO_GFXTIM_LCKCAL_1    (GPIO_ALT|GPIO_AF3|GPIO_PORTA|GPIO_PIN8)
#define GPIO_GFXTIM_LCKCAL_2    (GPIO_ALT|GPIO_AF3|GPIO_PORTE|GPIO_PIN15)
#define GPIO_GFXTIM_TE_1        (GPIO_ALT|GPIO_AF10|GPIO_PORTB|GPIO_PIN7)
#define GPIO_GFXTIM_TE_2        (GPIO_ALT|GPIO_AF10|GPIO_PORTB|GPIO_PIN15)
#define GPIO_GFXTIM_TE_3        (GPIO_ALT|GPIO_AF10|GPIO_PORTF|GPIO_PIN10)
#define GPIO_GFXTIM_TE_4        (GPIO_ALT|GPIO_AF10|GPIO_PORTF|GPIO_PIN11)
#define GPIO_GFXTIM_TE_5        (GPIO_ALT|GPIO_AF10|GPIO_PORTG|GPIO_PIN5)
#define GPIO_GFXTIM_FCKCAL_2    (GPIO_ALT|GPIO_AF3|GPIO_PORTD|GPIO_PIN7)

/* LPTIM4 - Low-power timer */

#define GPIO_LPTIM4_IN1_1       (GPIO_ALT|GPIO_AF11|GPIO_PORTD|GPIO_PIN13)
#define GPIO_LPTIM4_IN2_1       (GPIO_ALT|GPIO_AF11|GPIO_PORTF|GPIO_PIN11)
#define GPIO_LPTIM4_ETR_1       (GPIO_ALT|GPIO_AF8|GPIO_PORTD|GPIO_PIN2)
#define GPIO_LPTIM4_ETR_2       (GPIO_ALT|GPIO_AF8|GPIO_PORTF|GPIO_PIN12)
#define GPIO_LPTIM4_OUT_1       (GPIO_ALT|GPIO_AF11|GPIO_PORTD|GPIO_PIN7)
#define GPIO_LPTIM4_OUT_2       (GPIO_ALT|GPIO_AF11|GPIO_PORTF|GPIO_PIN13)

/* AUDIOCLK - Audio clock */

#define GPIO_AUDIOCLK_1         (GPIO_ALT|GPIO_AF12|GPIO_PORTA|GPIO_PIN0)
#define GPIO_AUDIOCLK_2         (GPIO_ALT|GPIO_AF12|GPIO_PORTB|GPIO_PIN0)
...
#define GPIO_DSI_TE_1           (GPIO_ALT|GPIO_AF10|GPIO_PORTF|GPIO_PIN10)
#define GPIO_DSI_TE_2           (GPIO_ALT|GPIO_AF10|GPIO_PORTF|GPIO_PIN11)
#define GPIO_DSI_TE_3           (GPIO_ALT|GPIO_AF10|GPIO_PORTG|GPIO_PIN5)

/* COMP1 - Comparator 1 */

#define GPIO_COMP1_OUT_1         (GPIO_ALT|GPIO_AF12|GPIO_PORTA|GPIO_PIN0)
#define GPIO_COMP1_OUT_2         (GPIO_ALT|GPIO_AF12|GPIO_PORTA|GPIO_PIN1)
#define GPIO_COMP1_OUT_3         (GPIO_ALT|GPIO_AF12|GPIO_PORTA|GPIO_PIN2)
#define GPIO_COMP1_OUT_4         (GPIO_ALT|GPIO_AF12|GPIO_PORTA|GPIO_PIN6)
#define GPIO_COMP1_OUT_5         (GPIO_ALT|GPIO_AF12|GPIO_PORTA|GPIO_PIN11)
#define GPIO_COMP1_OUT_6         (GPIO_ALT|GPIO_AF12|GPIO_PORTA|GPIO_PIN12)
#define GPIO_COMP1_OUT_7         (GPIO_ALT|GPIO_AF12|GPIO_PORTB|GPIO_PIN0)
#define GPIO_COMP1_OUT_8         (GPIO_ALT|GPIO_AF12|GPIO_PORTB|GPIO_PIN1)
#define GPIO_COMP1_OUT_9         (GPIO_ALT|GPIO_AF12|GPIO_PORTB|GPIO_PIN10)
#define GPIO_COMP1_OUT_10        (GPIO_ALT|GPIO_AF12|GPIO_PORTB|GPIO_PIN11)
#define GPIO_COMP1_OUT_11        (GPIO_ALT|GPIO_AF12|GPIO_PORTE|GPIO_PIN14)
#define GPIO_COMP1_OUT_12        (GPIO_ALT|GPIO_AF12|GPIO_PORTE|GPIO_PIN15)

/* COMP2 - Comparator 2 */

#define GPIO_COMP2_OUT_1         (GPIO_ALT|GPIO_AF12|GPIO_PORTA|GPIO_PIN0)
#define GPIO_COMP2_OUT_2         (GPIO_ALT|GPIO_AF12|GPIO_PORTA|GPIO_PIN2)
#define GPIO_COMP2_OUT_3         (GPIO_ALT|GPIO_AF12|GPIO_PORTA|GPIO_PIN3)
#define GPIO_COMP2_OUT_4         (GPIO_ALT|GPIO_AF12|GPIO_PORTA|GPIO_PIN4)
#define GPIO_COMP2_OUT_5         (GPIO_ALT|GPIO_AF12|GPIO_PORTA|GPIO_PIN5)
#define GPIO_COMP2_OUT_6         (GPIO_ALT|GPIO_AF12|GPIO_PORTA|GPIO_PIN12)
#define GPIO_COMP2_OUT_7         (GPIO_ALT|GPIO_AF12|GPIO_PORTB|GPIO_PIN1)
#define GPIO_COMP2_OUT_8         (GPIO_ALT|GPIO_AF12|GPIO_PORTB|GPIO_PIN2)
#define GPIO_COMP2_OUT_9         (GPIO_ALT|GPIO_AF12|GPIO_PORTB|GPIO_PIN11)
#define GPIO_COMP2_OUT_10        (GPIO_ALT|GPIO_AF12|GPIO_PORTB|GPIO_PIN12)
#define GPIO_COMP2_OUT_11        (GPIO_ALT|GPIO_AF12|GPIO_PORTE|GPIO_PIN15)

/* UCPD1 - USB Type-C and Power Delivery */

#define GPIO_UCPD1_CC1_1         (GPIO_ALT|GPIO_AF12|GPIO_PORTB|GPIO_PIN14)
#define GPIO_UCPD1_CC2_1         (GPIO_ALT|GPIO_AF12|GPIO_PORTB|GPIO_PIN15)
#define GPIO_UCPD1_FRSX_1         (GPIO_ALT|GPIO_AF12|GPIO_PORTB|GPIO_PIN13)

/* UCPD2 - USB Type-C and Power Delivery */

#define GPIO_UCPD2_CC1_1         (GPIO_ALT|GPIO_AF12|GPIO_PORTE|GPIO_PIN14)
#define GPIO_UCPD2_CC2_1         (GPIO_ALT|GPIO_AF12|GPIO_PORTE|GPIO_PIN15)
#define GPIO_UCPD2_FRSX_1         (GPIO_ALT|GPIO_AF12|GPIO_PORTE|GPIO_PIN13)

/* USART4 - Universal synchronous/asynchronous receiver transmitter */

#define GPIO_USART4_CK_1         (GPIO_ALT|GPIO_AF8|GPIO_PORTA|GPIO_PIN0)
#define GPIO_USART4_CK_2         (GPIO_ALT|GPIO_AF8|GPIO_PORTC|GPIO_PIN12)
#define GPIO_USART4_CTS_1        (GPIO_ALT|GPIO_AF8|GPIO_PORTB|GPIO_PIN7)
#define GPIO_USART4_RTS_DE_1    (GPIO_ALT|GPIO_AF8|GPIO_PORTA|GPIO_PIN15)
#define GPIO_USART4_RTS_DE_2    (GPIO_ALT|GPIO_AF8|GPIO_PORTB|GPIO_PIN14)
#define GPIO_USART4_RX_1         (GPIO_ALT|GPIO_AF8|GPIO_PORTA|GPIO_PIN1)
#define GPIO_USART4_RX_2         (GPIO_ALT|GPIO_AF8|GPIO_PORTC|GPIO_PIN11)
#define GPIO_USART4_RX_3         (GPIO_ALT|GPIO_AF8|GPIO_PORTE|GPIO_PIN7)
#define GPIO_USART4_TX_1         (GPIO_ALT|GPIO_AF8|GPIO_PORTA|GPIO_PIN0)
#define GPIO_USART4_TX_2         (GPIO_ALT|GPIO_AF8|GPIO_PORTC|GPIO_PIN10)
#define GPIO_USART4_TX_3         (GPIO_ALT|GPIO_AF8|GPIO_PORTE|GPIO_PIN8)

/* USART5 - Universal synchronous/asynchronous receiver transmitter */

#define GPIO_USART5_CK_1         (GPIO_ALT|GPIO_AF8|GPIO_PORTB|GPIO_PIN5)
#define GPIO_USART5_CK_2         (GPIO_ALT|GPIO_AF8|GPIO_PORTE|GPIO_PIN12)
#define GPIO_USART5_CTS_1        (GPIO_ALT|GPIO_AF8|GPIO_PORTB|GPIO_PIN5)
#define GPIO_USART5_RTS_DE_1    (GPIO_ALT|GPIO_AF8|GPIO_PORTB|GPIO_PIN4)
#define GPIO_USART5_RTS_DE_2    (GPIO_ALT|GPIO_AF8|GPIO_PORTE|GPIO_PIN7)
#define GPIO_USART5_RX_1         (GPIO_ALT|GPIO_AF8|GPIO_PORTB|GPIO_PIN4)
#define GPIO_USART5_RX_2         (GPIO_ALT|GPIO_AF8|GPIO_PORTD|GPIO_PIN2)
#define GPIO_USART5_RX_3         (GPIO_ALT|GPIO_AF8|GPIO_PORTE|GPIO_PIN11)
#define GPIO_USART5_TX_1         (GPIO_ALT|GPIO_AF8|GPIO_PORTB|GPIO_PIN3)
#define GPIO_USART5_TX_2         (GPIO_ALT|GPIO_AF8|GPIO_PORTC|GPIO_PIN12)
#define GPIO_USART5_TX_3         (GPIO_ALT|GPIO_AF8|GPIO_PORTE|GPIO_PIN10)

/* LPUART2 - Low-power UART */

#define GPIO_LPUART2_CTS_1       (GPIO_ALT|GPIO_AF3|GPIO_PORTB|GPIO_PIN13)
#define GPIO_LPUART2_RTS_DE_1  (GPIO_ALT|GPIO_AF3|GPIO_PORTB|GPIO_PIN12)
#define GPIO_LPUART2_RX_1        (GPIO_ALT|GPIO_AF3|GPIO_PORTB|GPIO_PIN11)
#define GPIO_LPUART2_TX_1        (GPIO_ALT|GPIO_AF3|GPIO_PORTB|GPIO_PIN10)
...
/* FDCAN2 - FD Controller Area Network */

#define GPIO_FDCAN2_RX_1        (GPIO_ALT|GPIO_AF9|GPIO_PORTB|GPIO_PIN5)
#define GPIO_FDCAN2_RX_2        (GPIO_ALT|GPIO_AF9|GPIO_PORTD|GPIO_PIN12)
#define GPIO_FDCAN2_TX_1        (GPIO_ALT|GPIO_AF9|GPIO_PORTB|GPIO_PIN6)
#define GPIO_FDCAN2_TX_2        (GPIO_ALT|GPIO_AF9|GPIO_PORTD|GPIO_PIN13)
...
#define GPIO_TIM8_CH1_1         (GPIO_ALT|GPIO_AF3|GPIO_PORTA|GPIO_PIN5)
#define GPIO_TIM8_CH2_1         (GPIO_ALT|GPIO_AF3|GPIO_PORTA|GPIO_PIN6)
#define GPIO_TIM8_CH3_1         (GPIO_ALT|GPIO_AF3|GPIO_PORTA|GPIO_PIN7)
...
#define GPIO_TIM8_CH3N_1        (GPIO_ALT|GPIO_AF3|GPIO_PORTB|GPIO_PIN1)
#define GPIO_TIM8_BKIN_1        (GPIO_ALT|GPIO_AF3|GPIO_PORTA|GPIO_PIN6)
#define GPIO_TIM8_BKIN2_1       (GPIO_ALT|GPIO_AF3|GPIO_PORTB|GPIO_PIN7)

/* TIM15 - General-purpose timer */
...
#define GPIO_TIM16_CH1_1        (GPIO_ALT|GPIO_AF14|GPIO_PORTA|GPIO_PIN6)
#define GPIO_TIM16_CH1N_1       (GPIO_ALT|GPIO_AF14|GPIO_PORTA|GPIO_PIN6)
#define GPIO_TIM16_BKIN_1       (GPIO_ALT|GPIO_AF14|GPIO_PORTA|GPIO_PIN13)

/* TIM17 - General-purpose timer */

#define GPIO_TIM17_CH1_1        (GPIO_ALT|GPIO_AF14|GPIO_PORTA|GPIO_PIN7)
#define GPIO_TIM17_CH1N_1       (GPIO_ALT|GPIO_AF14|GPIO_PORTB|GPIO_PIN5)
#define GPIO_TIM17_BKIN_1       (GPIO_ALT|GPIO_AF14|GPIO_PORTB|GPIO_PIN4)

/* LPTIM2 - Low-power timer */

#define GPIO_LPTIM2_IN1_1       (GPIO_ALT|GPIO_AF14|GPIO_PORTA|GPIO_PIN4)
#define GPIO_LPTIM2_IN2_1       (GPIO_ALT|GPIO_AF14|GPIO_PORTA|GPIO_PIN5)
#define GPIO_LPTIM2_ETR_1       (GPIO_ALT|GPIO_AF14|GPIO_PORTE|GPIO_PIN0)
#define GPIO_LPTIM2_OUT_1       (GPIO_ALT|GPIO_AF14|GPIO_PORTA|GPIO_PIN4)

/* LPTIM3 - Low-power timer */

#define GPIO_LPTIM3_IN1_1       (GPIO_ALT|GPIO_AF14|GPIO_PORTB|GPIO_PIN7)
#define GPIO_LPTIM3_IN2_1       (GPIO_ALT|GPIO_AF14|GPIO_PORTB|GPIO_PIN8)
#define GPIO_LPTIM3_ETR_1       (GPIO_ALT|GPIO_AF14|GPIO_PORTC|GPIO_PIN2)
#define GPIO_LPTIM3_OUT_1       (GPIO_ALT|GPIO_AF14|GPIO_PORTB|GPIO_PIN7)
