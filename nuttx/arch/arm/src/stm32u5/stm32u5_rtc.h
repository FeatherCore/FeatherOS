/****************************************************************************
 * arch/arm/src/stm32u5/stm32u5_rtc.h
 *
...
#ifndef __ARCH_ARM_SRC_STM32U5_STM32U5_RTC_H
#define __ARCH_ARM_SRC_STM32U5_STM32U5_RTC_H
...
#define STM32U5_RTC_PRESCALER_SECOND         32767  /* Default prescaler to get a second base */
#define STM32U5_RTC_PRESCALER_MIN            1      /* Maximum speed of 16384 Hz */

#if !defined(CONFIG_STM32U5_RTC_MAGIC)
#  define CONFIG_STM32U5_RTC_MAGIC           (0xfacefeee)
#endif

#if !defined(CONFIG_STM32U5_RTC_MAGIC_TIME_SET)
#  define CONFIG_STM32U5_RTC_MAGIC_TIME_SET  (0xf00dface)
#endif

#if !defined(CONFIG_STM32U5_RTC_MAGIC_REG)
#  define CONFIG_STM32U5_RTC_MAGIC_REG       (0)
#endif

#define RTC_MAGIC                           CONFIG_STM32U5_RTC_MAGIC
#define RTC_MAGIC_TIME_SET                  CONFIG_STM32U5_RTC_MAGIC_TIME_SET
#define RTC_MAGIC_REG                       STM32U5_RTC_BK0R
 ...
 *
 * Description:
 *   Instantiate the RTC lower half driver for the STM32U5.  General usage:
 *
 *     #include <nuttx/timers/rtc.h>
 *     #include "stm32u5_rtc.h>
 *
 *     struct rtc_lowerhalf_s *lower;
 *     lower = stm32u5_rtc_lowerhalf();
...
#endif
#endif /* __ASSEMBLY__ */
#endif /* __ARCH_ARM_SRC_STM32U5_STM32U5_RTC_H */